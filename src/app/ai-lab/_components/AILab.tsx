...
import AILabAdaptation from "./AILabAdaptation";
import AILabPalmReading from "./AILabPalmReading";
import AILabSongRecording from "./AILabSongRecording";
import AILabWorkSeries from "./AILabWorkSeries";
...
import type { AILabDefaultProps, AILabProps } from "../_types/aiLab";
...
export default function AILab(props: AILabProps) {
  ...
  return <DefaultAILab {...props} />;
}

function DefaultAILab({
  rank,
  title,
  blurb,
