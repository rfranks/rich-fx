...
import { UNREACHED_REVEAL_ITEM_SX } from "@/consts/components/shared/revealNavigator";
import { useRevealStateEngine } from "@/hooks/navigation/useRevealStateEngine";
import type { RevealNavigatorProps } from "@/types/components/shared/navigation";
import type { RevealViewMode } from "@/types/navigation/revealStateEngine";

export default function RevealNavigator<TKey extends string>({
  items,
  onSelect,
  mode,
  onModeChange,
  scope,
}: RevealNavigatorProps<TKey>) {
            ...
            return (
              ...
              >
                ...
                <Chip
                  ...
                  sx={item.reached ? undefined : UNREACHED_REVEAL_ITEM_SX}
                />
              </Stack>
            );
          })}
